<x-form-section submit="updateProfileInformation">
    ...
    <x-slot name="form">
        <!-- Cover Photo -->
        <div x-data="{coverName: null, coverPreview: null}" class="col-span-6">
            ...
            <!-- Current Cover Photo -->
            <div class="mt-2 h-32 w-full bg-gray-100 rounded-md overflow-hidden" x-show="! coverPreview">
                @if($this->user->cover_photo_path)
                    <img src="{{ Storage::url($this->user->cover_photo_path) }}" class="w-full h-full object-cover">
                @else
            ...
            <div class="mt-2 h-32 w-full rounded-md overflow-hidden" x-show="coverPreview" style="display: none;">
        ...
        <div class="col-span-6 sm:col-span-4">
            ...
            <textarea id="bio" class="mt-1 block w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm" wire:model="state.bio" rows="4"></textarea>
